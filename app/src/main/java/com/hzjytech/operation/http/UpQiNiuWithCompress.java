...
public class UpQiNiuWithCompress {
    ...
    private ArrayList filename_list=new ArrayList<>();
    private boolean needFile;

    public UpQiNiuWithCompress(Context context) {
        this(context,false);
    }
    public UpQiNiuWithCompress(Context context,boolean needFile) {
            ...
            public void complete(
                ...
                try {
                    ...
                    if (upimg_key_list.size() == urls.size()) {
                        if(needFile){
                            RxBus.getDefault().send(filename_list);
                        }else {
